...
$(document).ready(function(){
  $(selector).inputmask("99-9999999");  //site mask
...
```javascript
$(document).ready(function(){
  $(selector).inputmask("aa-9999");  //site mask
  $(selector).inputmask({mask: "aa-9999"});  //site mask
});
```
...
```javascript
$(document).ready(function(){
  $(selector).inputmask("aa-9{4}");  //site mask with dynamic syntax
