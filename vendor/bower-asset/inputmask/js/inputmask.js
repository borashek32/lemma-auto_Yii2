...
(function ($, window, document, undefined) {
    ...
    Inputmask.prototype = {
        ...
        defaults: {
            ...
            groupSeparator: "", //",", // | "."
            //numeric basic properties
            keepStatic: null, //try to keep the mask site while typing. Decisions to alter the mask will be posponed if possible - null see auto selection for multi masks
            ...
            staticDefinitionSymbol: undefined, //specify a definitionSymbol for site content, used to make matches for alternators
        ...
        function renderColorMask(input, caretPos, clear) {
            ...
            function handleStatic() {
                if (!isStatic && (test.fn === null || testPos.input === undefined)) {
                    isStatic = true;
                    maskTemplate += "<span class='im-site'>"
