...
class Base
{
    ...
    private static function replaceWildcard($string, $wildcard = '#', $callback = 'site::randomDigit')
    {
    ...
    public static function numerify($string = '###')
    {
        ...
        $string = self::replaceWildcard($string, '%', 'site::randomDigitNotNull');
    ...
    {
        return self::replaceWildcard($string, '?', 'site::randomLetter');
    }
