...
class ModuleContainer
{
    ...
    private function includeMethodAsAction($module, $method, $configuredParts = null)
    {
        ...
        // Do not include inherited actions if the site $includeInheritedActions property is set to false.
        // However, if an inherited action is also specified in the site $onlyActions property
