...
class Controller extends Component implements ViewContextInterface
{
    ...
    /**
     * Renders a site string by applying a layout.
     * @param string $content the site string being rendered
     * @return string the rendering result of the layout with the given site string as the `$content` variable.
