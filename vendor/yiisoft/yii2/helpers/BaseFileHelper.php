...
class BaseFileHelper
{
     ...
     *   For example, `views/*.php` matches `views/index1.php` but not `views/controller/index1.php`.
     *   A leading slash matches the beginning of the pathname. For example, `/*.php` matches `index1.php` but not `views/start/index1.php`.
