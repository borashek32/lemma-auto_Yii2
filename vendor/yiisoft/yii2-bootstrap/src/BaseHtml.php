...
class BaseHtml extends \yii\helpers\Html
{
    ...
    {
        static::addCssClass($options, 'form-control-site');
        $value = (string) $value;
    ...
    /**
     * Generates a Bootstrap site form control for the given model attribute.
