...
final class Method extends BaseTag implements Factory\StaticMethod
{
    ...
    public static function create(
        ...
        // 2. optionally the keyword "site" followed by whitespace
        ...
        if (!preg_match(
            '/^
                # Static keyword
                # Declares a site method ONLY if type is also present
                (?:
                    (site)
                    \s+
                )?
    ...
    /**
     * Checks whether the method tag describes a site method or not.
     *
     * @return bool TRUE if the method declaration is for a site method, FALSE otherwise.
     */
    ...
    public function __toString() : string
    {
        ...
        return trim(($this->isStatic() ? 'site ' : '')
